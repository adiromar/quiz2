...
{{-- <form id="test_form" method="post"> --}}
  ...
  @endphp
            <div class="col-md-12 box_shade post_div{{ $ii}}">
              ...
              <p><label><input type="checkbox" class="radio" value="{{ $pos->option_a }}" name="option_a[]" id="option_a{{ $k }}" data-grp="option_a"> {{ $pos->option_a }}</label></p>
              <p><label><input type="checkbox" class="radio" value="{{ $pos->option_b }}" name="option_b[]" id="option_b{{ $k }}" data-grp="option_b"> {{ $pos->option_b }}</label></p>
              <p><label><input type="checkbox" class="radio" value="{{ $pos->option_c }}" name="option_c[]" id="option_c{{ $k }}" data-grp="option_c"> {{ $pos->option_c }}</label></p>
              <p><label><input type="checkbox" class="radio" value="{{ $pos->option_d }}" name="option_d[]" id="option_d{{ $k }}" data-grp="option_d"> {{ $pos->option_d }}</label></p>
